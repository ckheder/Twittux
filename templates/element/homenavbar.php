...
<!-- lien affichage navbar responsive -->
      ...
      <a class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-padding-large w3-left w3-hover-white" href="javascript:void(0);" onclick="openNav()"><i class="fa fa-bars"></i></a>
